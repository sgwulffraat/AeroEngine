...
AoAR = AoA * np.pi/180
Results1 = Cp_calculatorVP(X1, Y1, Geom1[0], Geom1[1], Geom1[2], Geom1[3], Geom1[4], V_fs, AoAr)
Results2 = Cp_calculatorVP(X2, Y2, Geom2[0], Geom2[1], Geom2[2], Geom2[3], Geom2[4], V_fs, AoAr)
