...
if flag1 == "None":
    ...
    Naca2 = (12, 12, "naca0012_50", "naca0012_100", "Panels 2")
    flag2 = Naca2[4]
else:
    Naca2 = []
    flag2 = ""
...
if flag1 != "Reference" and flag1 != "Panels":
    fig = plt.figure(1)
...
if flag1 == "None":
    fig3 = plt.figure()
    plt.plot(XC1, Cp1, color='orange', marker='o', label=str(Naca[2]), markersize=2)
    plt.plot(XC3, Cp3, color='blue', marker='o', label=str(Naca2[2]), markersize=2)
    ...
    fig4 = plt.figure()
    plt.plot(XC2, Cp2, color='orange', marker='o', label=str(Naca[3]), markersize=2)
    plt.plot(XC4, Cp4, color='blue', marker='o', label=str(Naca2[3]), markersize=2)
    plt.plot([], [], ' ', label=chr(945) + " = " + str(AoA))
    plt.gca().invert_yaxis()
    plt.xlim([0, 1])
    plt.xlabel('x/c')
...
fig5 = plt.figure()
if flag1 == "Reference":
    plt.plot(abbot_alpha, abbot_cl, label='Abbot', linestyle="", marker='^', markersize=2, color='red')
    plt.plot(gregory_alpha, gregory_cl, label='Gregory', linestyle="", marker='s', markersize=2, color='green')
    plt.plot(alpha, cl_polar1_xfoil, label='Xfoil', color='blue', marker='o', markersize=2)
    plt.plot(alpha, cl_polar1, label='Model', color='orange', marker='.', markersize=2)
if flag1 == "None" or flag1 == "Panels":
    plt.plot(alpha, cl_polar1, label=str(Naca[2]), color='orange', marker='o', markersize=2)
    plt.plot(alpha, cl_polar3, label=str(Naca2[2]), color='blue', marker='o', markersize=2)
    plt.plot(alpha, cl_polar2, label=str(Naca[3]), color='green', marker='o', markersize=2)
    plt.plot(alpha, cl_polar4, label=str(Naca2[3]), color='red', marker='o', markersize=2)
    if flag2 == "Panels 2":
        plt.plot(alpha, cl_polar1_xfoil, label="XFOIL", color='purple', marker='^', markersize=2)
if flag1 == "Camber":
    plt.plot(alpha, cl_polar1, label=str(Naca[2]), color='orange', marker='o', markersize=2)
    plt.plot(alpha, cl_polar2, label=str(Naca[3]), color='blue', marker='o', markersize=2)
...
if flag1 == "Camber":
    fig6 = plt.figure()
    plt.plot(XC1, Cp1, color='orange', marker='o', label=str(Naca[2]), markersize=2)
    plt.plot(XC2, Cp2, color='blue', marker='o', label=str(Naca[3]), markersize=2)
    plt.plot([], [], ' ', label=chr(945) + " = " + str(AoA))
    plt.gca().invert_yaxis()
    plt.xlim([0, 1])
    plt.xlabel('x/c')
...
### PANEL DENSITY ###
if flag1 == "Panels":
    xfoil_cp_u_1, xfoil_cp_l_1, xfoil_x_u_1, xfoil_x_l_1, xfoil_cl_1 = xfoil(NACAcode1, AoA, 166)
    fig3 = plt.figure()
    plt.plot(XC1, Cp1, color='orange', marker='o', label="10 Panels", markersize=2)
    plt.plot(XC2, Cp2, color='blue', marker='o', label="20 Panels", markersize=2)
    plt.plot(XC3, Cp3, color='green', marker='o', label="50 Panels", markersize=2)
    plt.plot(XC4, Cp4, color='red', marker='o', label="100 Panels", markersize=2)
    plt.plot(xfoil_x_u_1, xfoil_cp_u_1, color='purple', marker='^', label='XFOIL (166 Panels)', markersize=2)
    plt.plot(xfoil_x_l_1, xfoil_cp_l_1, color='purple', marker='^', markersize=2)
    plt.plot([], [], ' ', label=chr(945) + " = " + str(AoA))
    plt.gca().invert_yaxis()
    plt.xlim([0, 1])
    plt.xlabel('x/c')
    plt.ylabel('C_p')
    plt.title("Cp distribution for varying panel density")
    plt.legend()
    plt.grid()
    plt.show()
